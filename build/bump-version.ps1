# Version bump script for Gido Touch Mini
...
Write-Host "   Gido Touch Mini Version Bump Script"  -ForegroundColor Cyan
Write-Host "========================================"  -ForegroundColor Cyan
Write-Host ""
...
$newVersion = Read-Host 'Enter new version (format: 1.5.1)'

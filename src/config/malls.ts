...
const createGenre = (mallId: MallId, id: string, name: string, name_en: string, filenameBase: string): Genre => ({
  id,
  name,
  name_en, // 英語名を設定
...
const createFacility = (mallId: MallId, id: string, name: string, name_en: string, filename: string, mapIconFilename?: string): Facility => {
...
const suzakaGenres: Genre[] = [
  createGenre("suzaka", "all", "すべて", "All", "all"),
  createGenre("suzaka", "fashion", "ファッション", "Fashion", "fashion"),
  createGenre("suzaka", "fashion_goods", "ファッション雑貨", "Fashion Goods", "fashion-goods"),
  createGenre("suzaka", "sport", "スポーツ＆アウトドア", "Sport & Outdoor", "sport"),
  createGenre("suzaka", "kids", "キッズ", "Kids", "kids"),
  createGenre("suzaka", "lifestyle", "ライフスタイル", "Lifestyle", "lifestyle"),
  createGenre("suzaka", "gourmet", "グルメ", "Gourmet", "gourmet"),
  createGenre("suzaka", "entertainment", "エンターテインメント", "Entertainment", "entertainment"),
  createGenre("suzaka", "service", "サービス", "Service", "survice"),
];

const suzakaFacilities: Facility[] = [
  createFacility("suzaka", "info", "インフォメーション", "Information", "info.svg"),
  createFacility("suzaka", "restroom", "トイレ", "Restroom", "restroom.svg"),
  createFacility("suzaka", "priority_restroom", "優先トイレ", "Priority Restroom", "priority-restroom.svg"),
  createFacility("suzaka", "baby_room", "ベビールーム", "Baby Room", "baby-room.svg"),
  createFacility("suzaka", "smoking_room", "喫煙所", "Smoking Room", "smoking-room.svg"),
  createFacility("suzaka", "free_coin_lockers", "無料コインロッカー", "Free Coin Lockers", "free-coin-lockers.svg"),
  createFacility("suzaka", "atm", "ATM", "ATM", "atm.svg"),
  createFacility("suzaka", "elevator", "エレベーター", "Elevator", "elevator.svg"),
  createFacility("suzaka", "bus_stop", "バス乗り場", "Bus Stop", "bus-stop.svg"),
  createFacility("suzaka", "taxi_stand", "タクシーのりば", "Taxi Stand", "taxi-stand.svg"),
];
